 ...
 */
	...
	[_LOWER] = LAYOUT(
		...
		_______,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,   KC_SCLN, KC_PGUP, _______,
 ...
 */
	...
	[_RAISE] = LAYOUT(
		...
		_______,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NO,   KC_NO,   KC_NO,   _______,
 ...
 */
	...
	/*
 * ,---------------------------------------------------------------.
 * |    |Spc 1 |Spc 2|Spc 3|Spc 4|Spc 5|    |    |Web Console|    |    |        |
 * |---------------------------------------------------------------|
 * |      |    |    |    |    |    | left | down | up | right |    |      |
 * |---------------------------------------------------------------|
 * |        |    |    |    |    |    |     |    | SG L   | SG R  |     |
 ...
 */
	...
	[_NAVIGATION] = LAYOUT(
		_______, C(KC_1),    C(KC_2),    C(KC_3),    C(KC_4),    C(KC_5),    _______,    _______,    A(G(KC_I)),    _______,    _______,    _______,
		...
		_______, _______, _______, _______,  _______,  G(KC_UP), _______, G(KC_DOWN)
	),
};
